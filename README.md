...
In this experiment context, VotingEnsemble was considered the best model, based on the Accuracyd metric using Azure AutoML. VotingEnsemble implements soft-voting which uses weighted averages. Basically, we created the classifiers and created the Voting Ensemble object and passed those classifiers.
